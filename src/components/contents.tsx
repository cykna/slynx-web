...
export function GettingStarted() {
  return (
    <>
      <Topic title="Getting started">Bla bla bla bli blo blu</Topic>
    </>
  );
}
...
export function TopicPreview(args: PageContentArgs) {
  return (
    <div className="topic-preview" onClick={args.click}>
      <div>
        <h1 className="topic-title">{args.title}</h1>
      </div>
...
export default function Contents() {
  ...
  return (
    <div className="contents">
      ...
      <div className="content-center">{centerChild ? centerChild : false}</div>
      <div className="right-content" ref={left as any}>
        ...
        <TopicPreview
          ...
          click={() => setCenterChild(GettingStarted())}
        >
